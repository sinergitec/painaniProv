...
import com.sienrgitec.painaniprov.adapter.opPedProvXentregarApadter;
...
public class perdidoxentregarActivity extends AppCompatActivity {
    ...
    private opPedProvXentregarApadter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perdidosxentregar);
    ...
    public void getPedidos (int ipiProveedor , int ipiDomicilio ){
       ...
       // String urlParams = String.format(url + "opPedidoProveedor?ipiProveedor=%1$s&ipcCuales=%2$s", ipiProveedor, "XENTREGAR");
        String urlParams = String.format(url + "opPedidoProveedor?ipiProveedor=%1$s&ipiDomicilio=%2$s&ipcCuales=%3$s", ipiProveedor, ipiDomicilio, "XENTREGAR");
                ...
                (Request.Method.GET, urlParams, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            adapter = new opPedProvXentregarApadter(perdidoxentregarActivity.this, (ArrayList<opPedidoProveedor>) arrayPedProv);
...
*/
                            ...
                            AlertDialog.Builder myBuild = new AlertDialog.Builder(perdidoxentregarActivity.this);
